...
class OCPTableViewController: UITableViewController {
    // MARK: Properties
    var ocp = OCP()
    var content: [String] = []
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cellIdentifier = "OCPContentCell"
        
        let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as! OCPContentCell
